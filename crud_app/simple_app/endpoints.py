...
con_string = "mongodb+srv://dhanasekar:dhanasekar@cluster0.orpas7l.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('Demo')

user_collection = pymongo.collection.Collection(db, 'Data')
print("MongoDB connected Successfully")


def project_api_routes(endpoints):
    @endpoints.route('/assign', methods=['GET'])
    def hello():
        res = 'KAAR'
        print("KAAR")
        return res                   
    ...
    @endpoints.route('/database',methods=['GET'])
    def read_users():
        resp = {}
        try:
